...
export const Welcome = ({ catchProvider, allNotes, setHideMichi }) => {
    ...
    return (
        <div className='welcome'>
            ...
            <section className='rigth'>
                <button className='googleBtn' onClick={() => registerWithGoogle(allNotes, setHideMichi)}>Continua con Google</button>
